...
import 'package:WarmDoctor/widget/Bar/CommonBar.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:WarmDoctor/Widget/scroll/my_behavior.dart';
    ...
    return new Scaffold(
      ...
      appBar: new ComMomBar(
        ...
        rightDMActions: <Widget>[
          new MaterialButton(
            onPressed: () => launch('https://github.com/hubojing/WarmDoctor'),
